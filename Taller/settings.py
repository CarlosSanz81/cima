...
SECRET_KEY = 'o^nk#lj5fz)-*av7)5tmt-u)l*t5rus@58m9i&!bbb&5o47k)l'
...
INSTALLED_APPS = [
    ...
    'papeles.apps.PapelesConfig',
    'proveedor.apps.ProveedorConfig',
    'formadepago.apps.FormadepagoConfig',
    'acabado.apps.AcabadoConfig',
    'modo.apps.ModoConfig',
    'gramajes.apps.GramajesConfig',
    'codpostales.apps.CodpostalesConfig',
    'transporte.apps.TransporteConfig',
    'iva.apps.IvaConfig',
    'laminado.apps.LaminadoConfig',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Taller', #os.path.join(BASE_DIR, 'db.sqlite3'),
        'USER': 'carlos',
        'PASSWORD': 'ester3033',
        'HOST': '127.0.0.1',
        'PORT': '5432',
